...
sudo echo "# custom psad logging directives
-A INPUT -j LOG
-A FORWARD -j LOG
-A INPUT -j LOG --log-tcp-options --log-prefix "[IPTABLES]"
-A FORWARD -j LOG --log-tcp-options --log-prefix "[IPTABLES]"" >> /home/pi/Documents/iptables_Append.txt

sudo echo "# log kernel generated IPTABLES log messages to file
